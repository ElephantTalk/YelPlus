...
import SplashCategories from "../splash/splash_categories";
...
const randomImage = () => {
  const images = [
    ...
    "https://s3-media0.fl.yelpcdn.com/assets/srv0/yelp_large_assets/b63753e02fe3/assets/img/home/hero_photos/w1be4pCC7p0rySKSbvSBPA.jpg",
...
class SplashPage extends React.Component {
  ...
  render() {
    return (
      <>
        <div className="splash-container-main-background">
