  ...
  render() {
    ...
    return (
      <div className="business-hour-only-container">
        ...
        <div>
          <div class="each-business-hour-right">
            {businessHour.monday_hour.slice(1)}{" "}
            <span>
              &nbsp;&nbsp;&nbsp;{this.openState(businessHour.monday_hour)}
            </span>
          </div>
          <div class="each-business-hour-right">
            {businessHour.tuesday_hour.slice(1)}{" "}
            <span>
              &nbsp;&nbsp;&nbsp;{this.openState(businessHour.tuesday_hour)}
            </span>
          </div>
          <div class="each-business-hour-right">
            {businessHour.wednesday_hour.slice(1)}{" "}
            <span>
              &nbsp;&nbsp;&nbsp;{this.openState(businessHour.wednesday_hour)}
            </span>
          </div>
          <div class="each-business-hour-right">
            {businessHour.thursday_hour.slice(1)}{" "}
            <span>
              &nbsp;&nbsp;&nbsp;{this.openState(businessHour.thursday_hour)}
            </span>
          </div>
          <div class="each-business-hour-right">
            {businessHour.friday_hour.slice(1)}{" "}
            <span>
              &nbsp;&nbsp;&nbsp;{this.openState(businessHour.friday_hour)}
            </span>
          </div>
          <div class="each-business-hour-right">
            {businessHour.saturday_hour.slice(1)}{" "}
            <span>
              &nbsp;&nbsp;&nbsp;{this.openState(businessHour.saturday_hour)}
            </span>
          </div>
          <div class="each-business-hour-right">
            {businessHour.sunday_hour.slice(1)}{" "}
            <span>
              &nbsp;&nbsp;&nbsp;{this.openState(businessHour.sunday_hour)}
            </span>
          </div>
        </div>
      </div>
